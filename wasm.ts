...
const wasmCode = await Deno.readFile("./target/wasm32-unknown-unknown/release/wasm_demo_32.wasm");
const wasmModule = new WebAssembly.Module(wasmCode);
const wasmInstance = new WebAssembly.Instance(wasmModule);
const add = wasmInstance.exports.add as CallableFunction;
console.log(add(1,2));
// const helloWasm = wasmInstance.exports.hello_wasm as CallableFunction;
// console.log(helloWasm());
// console.log(wasmInstance.exports.age(2,1))
